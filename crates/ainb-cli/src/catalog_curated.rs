...
pub const CATALOG_INDEX_REPO: &str = "stevengonsalvez/hangar";
...
mod tests {
    ...
    fn release_url_latest_uses_alias() {
        assert_eq!(
            ...
            "https://github.com/stevengonsalvez/hangar/releases/latest/download/catalog-index.json"
        );
    }
    ...
    fn release_url_tag_pins_exact() {
        assert_eq!(
            ...
            "https://github.com/stevengonsalvez/hangar/releases/download/v1.5.0/catalog-index.json"
        );
    }
