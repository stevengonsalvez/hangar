...
│   ├── ainb-core/              #   TUI + CLI binary (app, components, tmux, git, claude, config)
│   ├── ainb-app/               #   Application state, screens and the wire surface
